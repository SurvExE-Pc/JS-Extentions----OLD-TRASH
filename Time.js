...
return days(date_1, date_2);},
    ...
    full:function(){return `${Time.month()}/${Time.date()}/${Time.year()} ${Time.hour()}:${Time.min()}:${Time.sec()}:${Time.msec()}`;},
    fname:function(){let date = new Date(Time.full());return date;},
...
Date.prototype.Time = {
    Since:{
    daysSince:function(udate){
//prompt("What Date to start at?",'1/1/1999')
